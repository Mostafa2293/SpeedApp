...
public class GPSManager implements android.location.GpsStatus.Listener {
    ...
    public void startListening(final Context context) {
        ...
        /*this class "Criteria" indicating the application criteria for selecting a location provider.
          Providers may be ordered according to accuracy, power usage, ability to report altitude, speed,
           bearing, and monetary cost.
           the link for the documentation "https://developer.android.com/reference/android/location/Criteria"
         */
